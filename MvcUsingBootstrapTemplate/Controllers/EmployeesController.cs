...
namespace MvcUsingBootstrapTemplate.Controllers
{
    public class EmployeesController : Controller
    {
        private readonly northwindtradersContext _context;

        public EmployeesController(northwindtradersContext context)
        {
            _context = context;
        }
        ...
        {
            var northwindtradersContext = _context.Employees.Include(e => e.ReportsToNavigation);
            return View(await northwindtradersContext.ToListAsync());
        }
